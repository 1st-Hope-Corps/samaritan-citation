...
if(isset($_COOKIE['workz_share_id']) || isset($_GET['workz_share_id'])) {
	...
	<meta property="og:url" content="<?= url('', array( 'absolute' => true )).'?workz_share_id='.$oDetails->id ?>">
		...
		<div id="hopenet_main_content" class="winXP" style="padding: 30px;padding-top: 0px;">
			...
			<div id="hopenet_about_1st_hope_corps"  class="hopenet_main_module_container" style="height: auto;display: none;">
				...
				<div class="hopenet_middle_text_container">
					...
					valor and kindness performed by Samaritans without compensation for the
					...
					by awarding them with Valiant, which they can redeem for services and products
