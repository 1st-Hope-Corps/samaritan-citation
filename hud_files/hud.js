...
function ToggleContent(sContentType){
	...
	switch (sContentType){
		...
		break;
		case "peace_about":
			$("#content_breadcrumb").html('HUD &gt; Values Building');
			...
			break;
		case "peace_kindness":
			$("#content_breadcrumb").html('HUD &gt; Peace Building &gt; Kindness &gt; About');
		...
		case "peace_kindness_workz":
			$("#content_breadcrumb").html('HUD &gt; Peace Building &gt; Kindness Program &gt; Kindness Workz');
		...
		case "peace_kindness_act":
			$("#content_breadcrumb").html('HUD &gt; Peace Building &gt; Kindness Program &gt; Act of Kindness');
		...
		case "peace_kindness_reporter":
			$("#content_breadcrumb").html('HUD &gt; Peace Building &gt; Kindness Program &gt; Kindness Reporter');
			...
			break;
		case "peace_virtues":
			$("#content_breadcrumb").html('HUD &gt; Peace Building &gt; Virtues &amp; Values');
		...
		case "peace_spirituality":
			$("#content_breadcrumb").html('HUD &gt; Values Building &gt; HopeGames');
			...
			break;
		case "hope_main":
			$("#content_breadcrumb").html('HUD &gt; HopeNet Main');
		...
		case "hope_main_generic_faq":
			...
			break;
		case "hope_about_1st_hope_corps":
			$("#content_breadcrumb").html('HUD &gt; HopeNet Main &gt; About &gt; What is Hope Street');
			...
			break;
		case "hope_about_shuttle":
			$("#content_breadcrumb").html('HUD &gt; HopeNet Main &gt; About &gt; How does the Hope Shuttle work');
			...
			break;
		case "hope_about_hopenet":
			$("#content_breadcrumb").html('HUD &gt; HopeNet Main &gt; About &gt; How does HopeNet work');
			...
			break;
		case "hope_about_why_hope_corps":
			$("#content_breadcrumb").html('HUD &gt; HopeNet Main &gt; About &gt; Why Hope Street');
			...
			break;
		case "hope_about_legend":
			$("#content_breadcrumb").html('HUD &gt; HopeNet Main &gt; About &gt; The Legend of Hope');
			...
			break;
		case "carousel":
			$("#content_breadcrumb").html('HUD &gt; Knowledge Portal');
			$("#carousel_content").show();
		...
		case "entertainment_about":
			$("#content_breadcrumb").html('HUD &gt; Entertainment Portal');
		...
		case "entertainment":
			...
			break;
		case "mentoring":
			$("#content_breadcrumb").html('HUD &gt; Values Building &gt; Values Mentoring');
		...
		case "learning":
			...
			$("#content_breadcrumb").html('HUD &gt; eLearning');
		...
		case "bank_about":
			...
			break;
		case "bank_statement":
			$("#content_breadcrumb").html('HUD &gt; My vBank &gt; Bank Statement');
			Bank_GetStatement();
			$("#bank_content_statement").show();
			
			break;
		case "bank_withdraw":
			$("#content_breadcrumb").html('HUD &gt; My vBank &gt; Withdraw Bucks');
			Time_GetCredit();
			Time_SetWithdrawBuy();
			...
			break;
		case "bank_deposit":
			$("#content_breadcrumb").html('HUD &gt; My vBank &gt; Deposit Bucks');
			Kindness_GetDetails("bank");
			$("#bank_content_deposit").show();
			
			break;
		case "bank_loans":
			$("#content_breadcrumb").html('HUD &gt; My vBank &gt; Loans');
			$("#bank_content_loans").show();
			
			break;
		case "bank_economy":
			$("#content_breadcrumb").html('HUD &gt; My vBank &gt; Hope Economy');
			$("#bank_content_economy").show();
			
			break;
		case "kindness_about":
			$("#content_breadcrumb").html('HUD &gt; Workz &gt; About');
		...
		case "kindness_dashboard":
			$("#content_breadcrumb").html('HUD &gt; Workz');
		...
		case "kindness_convert":
			$("#content_breadcrumb").html('HUD &gt; Workz &gt; Convert');
		...
		/* case "kindness_pending_approved":
			$("#content_breadcrumb").html('HUD &gt; Workz &gt; Pending/Approved');
			Kindness_GetApproved();
			Kindness_GetPending();
		...
		case "kindness_form":
                    ...
                    $('#kindness_content_form').css({"width":"850px","margin-top": "25px","float":"left","padding": "10px","float": "left","margin-left": "83px","min-height":"1370px"});
                     
                    $('#kindness_report_left_section').css({"margin":"10px 0px 0px 10px","width":"265px","height":"auto","padding":"8px",});
                   
                    $('#kindness_report_right_section').css({"margin":"0px","height":"auto","padding-left":"36px","float":"left"});
                    $('#kindness_report_content_section').css("height", "1230px");
                    $('.kindness_image_report').css("width", "265px");
                    
			$("#content_breadcrumb").html('HUD &gt; Workz &gt; Report');
...
//			$(".jScrollPaneContainer").show();
			...
			break;
		case "time_tracker":
			$("#content_breadcrumb").html('HUD &gt; Fuel Tracking');
			Time_GetCredit();
            Time_SetWithdrawBuy();
			Time_GetHistory();
			...
			break;
		case "tutoring_ini":
			$("#content_breadcrumb").html('HUD &gt; eTutoring &gt  eTutoring');
            $("#tutoring_content_ini").show();
			
			break;
		case "tutoring_private":
			$("#content_breadcrumb").html('HUD &gt; eTutoring &gt Private eTutoring');
		...
		case "tutoring_start":
			...
			break;
		case "tutoring_form":
			$("#content_breadcrumb").html('HUD &gt; eTutoring &gt Instant Tutoring &gt; Instant Question &gt; Ask a Question');
			Tutor_GetDetails();
			//Tutor_SetCats();
			...
			break;
		case "tutoring_about":
			$("#content_breadcrumb").html('HUD &gt; eTutoring &gt; About');
            $("#tutoring_content_about").show();
			
			break;
		case "my_profile_about":
			$("#content_breadcrumb").html('HUD &gt; My Profile');
		...
		function(sReply){
			...
			if (iTutorPostLeft > 0){
				if (mBankBalance >= mTutorPostCost){
					...
					sNotice = "Your current balance is $ "+mBankBalance+". You do not have enough Valiants to post an Instant Question.<br/><br/>";
...
function Kindness_SetFormSubmit(){
	...
	if (iAlertMsgLen < sAlertMsg.length){
        ...
        var split = url.split('#');
        var url = split[0];
      url = url+'#kindness_report'; //redirect to same page
