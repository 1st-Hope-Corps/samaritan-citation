...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        var __SCOLLEVENTTEMP = "<DIV style=\"WIDTH:${width};top:${top};left:${left};\" title=\"${title}\" class=\"chip chip${i} ${drag}\"><div class=\"dhdV\" style=\"display:none\">${data}</div><DIV style=\"BORDER-BOTTOM-COLOR:${bdcolor}\" class=ct>&nbsp;</DIV><DL style=\"BORDER-BOTTOM-COLOR:${bdcolor}; BACKGROUND-COLOR:${bgcolor1}; BORDER-TOP-COLOR: ${bdcolor}; HEIGHT: ${height}px; BORDER-RIGHT-COLOR:${bdcolor}; BORDER-LEFT-COLOR:${bdcolor}\"><DT style=\"BACKGROUND-COLOR:${bgcolor2}\">${username} - ${starttime} - ${endtime} ${icon}</DT><DD><SPAN>${content}</SPAN></DD><DIV class='resizer' style='display:${redisplay}'><DIV class=rszr_icon>&nbsp;</DIV></DIV></DL><DIV style=\"BORDER-BOTTOM-COLOR:${bdcolor}; BACKGROUND-COLOR:${bgcolor1}; BORDER-TOP-COLOR: ${bdcolor}; BORDER-RIGHT-COLOR: ${bdcolor}; BORDER-LEFT-COLOR:${bdcolor}\" class=cb1>&nbsp;</DIV><DIV style=\"BORDER-BOTTOM-COLOR:${bdcolor}; BORDER-TOP-COLOR:${bdcolor}; BORDER-RIGHT-COLOR:${bdcolor}; BORDER-LEFT-COLOR:${bdcolor}\" class=cb2>&nbsp;</DIV></DIV>";
        ...
        //
        //gridcontainer.css("overflow-y", "visible").height(option.height - 9);
		gridcontainer.css("overflow-y", "visible").height(option.height - 87);
        ...
        function BuildDaysAndWeekView(startday, l, events, config) {
            ...
            html.push("<div id=\"dvtec\"  class=\"scolltimeevent\" style=\"height:480px !important\"><table style=\"table-layout: fixed;", jQuery.browser.msie ? "" : "width:100%", "\" cellspacing=\"0\" cellpadding=\"0\"><tbody><tr><td>");
        ...
        function BuildDayScollEventContainer(ht, dayarrs, events) {
            ...
            for (var i = 0; i < 24; i++) {
				...
				tmt2 = fomartTimeShow_time(tmt);
                ht.push("<div style=\"height: 41px\" class=\"tg-time\">", tmt2, "</div>");
            }
            ht.push("</td>");
        ...
        function BuildDayEvent(theme, e, index) {
			...
			if(element[1] == "Calendar" || element[1] == undefined){
				p.content = element[0];
				p.title = getTitle(e.event);
				p.data = e.event.join("$");
				var text = e.event[1];
				...
				var username = "Refresh";
				} else{
				var username = element[3];
				}
				p.username = username; 
				var icons = [];
				icons.push("<I class=\"cic cic-tmr\">&nbsp;</I>");
				...
				var elementzero = "No content yet";
				} else{
				var elementzero = element[0];
				}
				
				if(element[1] == undefined){
				var elementone = "Pending";
				} else{
				var elementone = element[1];
				}
				
				if(element[2] == undefined){
				var elementtwo = "No response, yet";
				} else{
				var elementtwo = element[2];
				}
				
				if(element[3] == undefined){
				var elementthree = "Refresh page";
				} else{
				var elementthree = element[3];
				}
			
				p.content = elementzero;
				p.title = elementzero;
				p.username = elementthree; 
				// eof added sched
				
				p.data = e.event.join("$");
				var icons = [];
				icons.push("<I class=\"cic cic-tmr\">&nbsp;</I><br/>Status : "+elementone+"<br/>Response : "+elementtwo);
				if (e.reevent) {
					icons.push("<I class=\"cic cic-spcl\">&nbsp;</I>");
				}
			}
		...
		function fomartTimeShow_time(h){
			var time = "";
			var calculate = "";
			if(h <= 11){
				if(h == 0){
            ...
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
                    var csbuddle = '<div id="bbit-cs-buddle" style="z-index: 180; width: 400px;visibility:hidden;" class="bubble"><table class="bubble-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="bubble-cell-side"><div id="tl1" class="bubble-corner"><div class="bubble-sprite bubble-tl"></div></div><td class="bubble-cell-main"><div class="bubble-top"></div><td class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root"><table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><div id="bbit-cs-what" title="'
                    	+ i18n.xgcalendar.click_to_detail + '"></div></div></div></td></tr><tr><td class=cb-value><div id="bbit-cs-buddle-timeshow"></div></td></tr></tbody></table><div class="bbit-cs-split"><input id="bbit-cs-id" type="hidden" value=""/> <span id="bbit-cs-delete" class="lk">'
					...
					if(element[1] == "Calendar" || element[1] == undefined){
						...
						var elementfour = "No location, yet";
						} else{
						var elementfour = element[4];
						}
						
						if(element[5] == undefined){
						var elementfive = "No remarks, yet";
						} else{
						var elementfive = element[5];
						}
						var str = "Cybrarian Volunteer: "+elementthree+"<br/>Subject: "+elementzero+"<br/>Status: "+elementone+"<br/>Location: "+elementfour+"<br/>Remarks: "+elementfive+"<br/><br/>Your Response: "+elementtwo;
					}
                    // added by sched
				    $("#bbit-cs-what").html(str);
