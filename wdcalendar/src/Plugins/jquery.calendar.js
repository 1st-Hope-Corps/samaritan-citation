...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        function dayshow(e, data) {
            ...
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
					...
					var str = "Cybrarian Volunteer: "+elementthree+"<br/>Subject: "+elementzero+"<br/>Status: "+elementone+"<br/>Response: "+elementtwo;
            ...
            if (buddle.length == 0) {
                ...
                calbutton.click(function(e) {
					...
					hiConfirm("Would you like to send a notification to the Cybrary Volunteer?", 'Send notification?',
						function(r){ 
							if(r == true){
							r && addnewQuickduty("send");
							} else if(r == false){
							addnewQuickduty("dontsend");
							}
						});     
				});
                lbtn.click(function(e) {
		...
		// added by jed diaz
		function addnewQuickduty(email){
					if (option.isloading) {
                        return false;
                    }
                    option.isloading = true;
