var i18n = $.extend({}, i18n || {}, {
    xgcalendar: {
        ...
        "confrim_delete_event_or_all": "Do you want to all repeat duties or only this event? \r\nClick [OK] to delete only this event, click [Cancel] delete all duties",
        "data_format_error": "Data format error! ",
        "invalid_title": "Event title can not be blank or contains ($<>)",
        "view_no_ready": "View is not ready",
        "example": "e.g., meeting with my teachers.",
        "content": "What",
