...
<div class="profile clearfix">
  ...
  <div class="col left clearfix">
    ...
    <div id="profile-intro" class="box">
      <div class="content clearfix">
        ...
        <dl class="fields">
          <dt style="display: none;">Age:</dt>
          <dd style="display: none;"><?php echo $sAge; ?></dd>
          <dt>Gender:</dt>
          <dd><?php echo $account->profile_gender; ?></dd>
          <dt>Views:</span></dd>
          <dt style="display: none;">Fans:</span></dd>
    ...
    <div id="profile-kindess-workz-summary" class="box">
      ...
      <div id='dialog_KindnessWorkz' style='display:none;'>
        ...
        <div class="kindness-txt">
          <center>
            <h3 id="KindnessWorkz_Title">Hope Workz Details</h3>
          </center>
        </div>
        <div style='text-align: left;padding-top:5px;padding-left:5px;overflow-y:auto;overflow-x:hidden;height:360px;'>
          ...
          <div style="margin-top:10px;" class="kindness-txt">
            <h3>Hope Workz Hours : Approved</h3>
      ...
      <div id='dialog_KindnessWorkz_Details' style='display:none;'>
        ...
        <div class="kindness-txt"><center><h3 id="KindnessWorkz_Details_Title">Hope Workz Details</h3></center></div>
        <div style='text-align: left;padding-top:5px;padding-left:5px;overflow-y:auto;overflow-x:hidden;height:360px;'>
      ...
      <div class="content clearfix">
        ...
        I&apos;ve performed <?php echo $sKindessWorkz; ?> of Hope Workz.
        <a href="#" data-uid="<?php echo $iUID; ?>">Click here for details.</a>
      </div>
    </div>

    <div id="profile-aid-status" class="box">
      <h3 class="title">Support Status</h3>
      <div class="content clearfix">
        <dl>
          <dt style="display: none;">eTutors:</dt>
          <dd style="display: none;">xx</dd>
          <dt>eMentors:</dt>
  ...
  <div class="col right">
    ...
    <div id="profile-wall" class="box">
      <h3 class="title">Workz Wall</h3>
      <div class="content clearfix">
        <?php echo user_ext_profile_wall_display( $user, $account ); ?>
      </div>
    </div>

    <div id="profile-friends" class="box" style="display:none;">
    ...
    <div id="profile-fans" class="box" style="display:none;">
    ...
    <div id="profile-photos" class="box" style="display:none;">
