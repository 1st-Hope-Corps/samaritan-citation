...
if ($user->uid == 0) header("Location: user?destination=hud.php");
...
if (_time_tracker_in_array(basename($_SERVER["SCRIPT_NAME"]), array("hud.php")) 
		&& in_array("Child / Student", $user->roles) 
		&& $user->uid > 1){
	...
	<div id="wrapper">
		...
		<div class="header">
			<div class="box_left">
				<div id="wrapper05">
					<div class="boxtop">
						<div class="text_area_mid_l"><span class="hl">Hi, <?php echo _time_tracker_get_name() ?>. Welcome Back.</span></div>
		...
		<div id="content_wrapper1">
			<div class="nav_left">
				<div class="example">
					<ul class="adxm menu">
						<li><span class="style1">&nbsp;&nbsp; HopeNet - Services &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
							<ul>
								<li> </li>
								<li><a style="cursor:pointer;" onclick="ToggleContent('hope_main');">HopeNet Main</a></li>
								<li>
									<div id="headerDivImgS">
										<a style="cursor:pointer;" onclick="Toggle('peace_sub'); ToggleContent('peace_about');">Peace Building</a>
									</div>
									<div id="peace_sub" style="display:none; height:38px;" class="boxbgleftdownS boxbgleftS">
										...
										<span class="hl" style="cursor:pointer;" onclick="ToggleContent('peace_virtues');">Virtues &amp; Values</span><br />
										<span class="hl" style="cursor:pointer;" onclick="ToggleContent('peace_spirituality');">Spirituality</span>
									</div>
								</li>
				...
				<div class="cpanel">
					<ul class="adxm menuc" id="cssonclickswitch2">
						<li><span class="mainlink">Control Panel</span>
							<ul id="cpanel_links">
								<li><a style="cursor:pointer;" onclick="$('#cpanel_links').hide();$('#agesetter').fadeIn();">Set Age</a></li>
								<li><a style="cursor:pointer" id="hud_stat_refresh_new">Update Statistics <span id="stat_update"> Updated...</span></a></li>
								<li><a style="cursor:pointer;" href="/logout">Logout</a></li>
							</ul>
							...
							<ul id="agesetter" style="display:none">
								<li>
									...
									<div class="ddholder">
										<select name="sAgeGroup" id="sAgeGroup">
			...
			<div class="nav_right">
				<div class="example2">
					<ul class="adxm menur" id="cssonclickswitch">
						<li><span class="style2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; HopeNet - Accounts &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
							<ul>
								<li><a style="cursor:pointer;" onclick="SetGeneric('Communication'); ToggleContent('generic'); $('#content_breadcrumb').html('HUD &gt; Communication');">Communication</a></li>
								<li>
									<div id="headerDivImgS">
								...
								<li><a style="cursor:pointer;" onclick="ToggleContent('my_profile_about');">My Profile</a></li>
							</ul>
						</li>
					</ul>
				</div>
		...
		<div id="hopenet_main_content" class="winXP" style="width:810px; margin:52px 0px 0px 95px;">
			<div id="hopenet_main" style="height:295px;">
				...
				<div id="hopenet_main_text" class="hopenet_main_right">
					<p>Hello, <?php echo _time_tracker_get_name() ?>. We are very happy to have you as a member of the 1st Hope Corps!
					The purpose of this HopeNet Main section is to explain the 1st Hope Corps, HopeNet and how your Hope Shuttle 
					Craft works, and to answer your questions.</p>
					
					<p>The 1st Hope Corps has given you command of your own Hope Shuttle. 
			...
			<div id="hopenet_about_1st_hope_corps" style="height:295px; display:none;">
				<div class="hopenet_main_left">
					<div class="kindness-title" style="font-size:0.75em; margin-bottom:1px;">What is the 1st Hope Corps</div>
					<img src="hud_files/images/main_about_hope_corps.jpg" />
				</div>
				<div class="hopenet_main_middle"></div>
				<div id="hopenet_about_1st_hope_corps_text" class="hopenet_main_right">
					<p>You have been assigned to the 1st Hope Corps.  The purpose of the Hope Corps is to create a movement for the 
					evolution of mankind - so that they may achieve peace and prosperity.  The primary members of the Hope Corps are 
					know as Hopefuls. Hopefuls can be any age, race, creed or color, but the age of  enrollment for the Hope Corps is 
			...
			<div id="hopenet_about_shuttle" style="height:295px; display:none;">
				...
				<div id="hopenet_about_shuttle_text" class="hopenet_main_right">
					...
					<p>As a Hopeful and a member of the Hope Corps you are part of a global community, but you are not separate from 
			...
			<div id="hopenet_about_hopenet" style="height:295px; display:none;">
				...
				<div id="hopenet_about_hopenet_text" class="hopenet_main_right">
					...
					HopeNet services.  Instead... as a member of the Hope Corps you are part of a very special and unique economic 
			...
			<div id="hopenet_about_why_hope_corps" style="height:295px; display:none;">
				<div class="hopenet_main_left">
					<div class="kindness-title">Why the Hope Corps</div>
			...
			<div id="hopenet_main_slider" style="margin:80px 0px 0px 10px;">
				...
				<div style="float:left; width:190px; cursor:pointer; margin-left:10px;" onclick="ToggleContent('hope_main_generic'); $('#content_breadcrumb').html('HUD &gt; HopeNet FAQ\'s'); $('#hopenet_main_generic_title').text('HopeNet FAQ\'s');"><img src="hud_files/images/temp_hopenet_main_faq.jpg" /></div>
		...
		<div id="carousel_content" style="display:none;">
			...
			<div id="Carousel" style="height:295px; margin-left: -215px;">
				<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" width="1239" height="609" id="carousel" align="middle">
					<param name="allowScriptAccess" value="sameDomain" />
					<param name="allowFullScreen" value="false" />
					...
					<param name="wmode" value="transparent" />
					<param name="bgcolor" value="#333333" />
					<embed src="hud_files/carousel.swf" quality="high" wmode="transparent" bgcolor="#333333" width="1239" height="609" name="carousel" align="middle" allowScriptAccess="sameDomain" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
				</object>
			</div>
			<div class="clear"></div>
		</div>
		...
		<!-- About -->
		<div class="wrapper-kindness" id="learning_about">
			<div class="wrapper-kindness01">
				<div class="kindness-title">Knowledge Portal</div>
				<div class="learning-about-image"></div>
				<div class="tutering-content01">
					...
					<h2 align="center" style="color:#FFF200; cursor:pointer;" onclick="location='hud.php?b=<?php echo md5(uniqid(rand(), true)) ?>'">Launch Knowledge Portal</h2>
				</div>
			</div>
		...
		<div id="entertainment_content" style="display:none;">
			<div id="Entertainment_Carousel" style="height:295px; margin-left: -215px;>
				<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" width="1239" height="609" id="entertainment_carousel" align="middle">
					...
					<param name="wmode" value="transparent" />
					<param name="bgcolor" value="#333333" />
					<embed src="hud_files/entertainment_carousel.swf" quality="high" wmode="transparent" bgcolor="#333333" width="1239" height="609" name="carousel" align="middle" allowScriptAccess="sameDomain" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
				</object>
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="wrapper-kindness" id="entertainment_content_about">
			<div class="wrapper-kindness01">
				...
				<div class="tutering-content01">
					<h2 align="center" style="color:#FFF200; cursor:pointer;" onclick="location='hud.php?e=<?php echo md5(uniqid(rand(), true)) ?>'">Launch Entertainment Portal</h2>
				</div>
			</div>
			<div class="wrapper-bank-r">
				<div class="bank-r">
				...
				<div class="bank-r">
					<div class="tuter_main_top_bg">
						...
						<div class="welcm_tutor_top_txt" style="color:#54EC1A; font-size:0.8em; margin:20px 0 0 10px; width:450px;">
							...
							<p align="center" onclick="ToggleContent('livelihood_commissary');" style="cursor:pointer; color:#FFF200; font-weight:bold;">
								Click here to see a demonstration of the eCommissary.
							</p>
							<br/>
							...
							<p align="center" onclick="ToggleContent('livelihood_store');" style="cursor:pointer; color:#FFF200; font-weight:bold;">
								Click here to see a demonstration of the My eStore.
							</p>
							<br/>
		...
		<div class="wrapper-bank winXP" id="bank_content_about">
			<div class="wrapper-bank01">
				...
				<div id="bank_about_text" class="bank-content01" style="margin-top:0px; width:287px; height:235px; overflow:auto;">
					...
					<h2 align="center" style="color:#FFF200; cursor:pointer;" onclick="ToggleContent('bank_economy');">Hope Economy</h2>
				</div>
			</div>
			<div class="wrapper-bank-r">
				<div class="bank-r">
						...
						<div class="bank-account-content01">
							<table width="450" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td>Balance</td>
									<td><span id="bank_balance"></span></td>
									<td>Hope Development Bank</td>
								</tr>
								<tr>
									<td>&nbsp;</td>
									<td>Pending</td>
									<td><span id="bank_pending"></span></td>
									<td>&nbsp;</td>
								</tr>
								<tr>
									<td>&nbsp;</td>
									<td>Turnover</td>
									<td><span id="bank_turnover"></span></td>
									<td>&nbsp;</td>
								</tr>
							</table>
						</div>
		...
		font-size:11px; color:#54ec1a; font-weight:bold">Bucks for deposit to my hope Cybrary Account</div>
									...
									<tr>
										<td>
											<input id="btnBankWithdrawSend" name="btnBankWithdrawSend" type="button" value="Send"  style=" background-color:#51644c; border:#54ec1a solid 1px; width:50px; height: 20px; font-family:Arial, Helvetica, sans-serif;
		...
		font-size:9px; color:#54ec1a; padding-top: 3px">These are the available blocks you can buy with your HOPE Bucks</td>
									...
									<tr>
										<td>
											<input id="btnBankWithdrawBuy" name="btnBankWithdrawBuy" type="button" value="Buy Selected Fuel Block"  style=" background-color:#51644c; border:#54ec1a solid 1px; width:150px; height: 20px; font-family:Arial, Helvetica, sans-serif;
		font-size:11px; color:#e5f031"/>
										</td>
									</tr>
								</table>
							...
							<tr>
								...
								<td style="vertical-align:top;">
									...
									<div style="clear:both; padding-left:5px; padding-top:5px">
										<input id="btnBankDeposit" name="btnBankDeposit" type="button" value="Convert To Valiants"  style="background-color:#51644c; border:#54ec1a solid 1px; width:150px; height: 18px; font-family:Arial, Helvetica, sans-serif; font-size:11px; color:#e5f031"/>
									</div>
				...
				<div class="kindness-content02">
					...
					<div class="kindness-txt">
					   ...
					   <div class="pending_top_txt">
							...
							<div class="pending_top_monitor">Monitor</div>
		...
		<div class="wrapper-kindness" id="kindness_content_convert">
			...
			<div class="wrapper-bank-r">
				...
				<div class="kindness-content02">
					<div class="kindness-txt">
						<div class="box01" style="color:#FFF200; width:230px; font-size:1.1em; background:url(hud_files/images/welcome_tutring.png) no-repeat scroll 0 0 transparent;">
						...
						<table>
							<tr>
								...
								<td style="vertical-align:top;">
									...
									<div class="kindness_panel_btn">
										<input id="btnKindnessConvert" name="btnKindnessConvert" type="button" value="Convert To Hope Bucks"  style="background-color:#51644c; border:#54ec1a solid 1px; width:150px; height: 18px; font-family:Arial, Helvetica, sans-serif;font-size:11px; color:#e5f031"/>
									</div>
								</td>
							</tr>
						</table>
		...
		<div class="wrapper-kindness winXP" id="kindness_content_form">
			<div class="wrapper-kindness01">
				...
				<div id="kindness_form_text" class="kindness-content01" style="margin-top:0px; width:287px; height:240px; overflow:auto;">
			...
			<div class="wrapper-bank-r" style="height:auto;">
				<div class="bank-r">
					<div class="kind_navi">
						<ul>
							<li><a href="javascript:ToggleContent('kindness_about')"><span>About</span></a></li>
				...
				<div class="report-content02">
								...
								<div class="report_input">
									<div>
										...
										foreach($aMonths as $key=>$value){
											...
											?>
											<option <?php echo $selected ?> value="<?php echo $k ?>"><?php echo $value ?></option>
											<?php
										}
										?>  
										</select>
					...
					<div class="report-main_botom">
						...
						<div class="report_botom_bg01">
							<input id="btnKindnessSubmit" name="btnKindnessSubmit" type="button" value="Submit Kindness Form" onclick="Kindness_SetFormSubmit();" style="background-color:#51644c; border:#54ec1a solid 1px; width:150px; height: 18px; font-family:Arial, Helvetica, sans-serif; font-size:11px; color:#e5f031" />
						</div>
					</div>
			...
			<div class="hud_kindness_quick_links" style="margin-top:3px; margin-left:44px; width:462px;">
				<div class="hud_kindness_quick_links_left" style="width:75px;">Quick Links:</div>
				<div class="hud_kindness_quick_links_right">
					<div class="hud_kindness_quick_links_right_links" style="width:150px;" onclick="ToggleContent('kindness_convert');">Convert</div>
					<div class="hud_kindness_quick_links_right_links" style="width:90px;" onclick="ToggleContent('kindness_dashboard')">Kindness Status</div>
		...
		<div class="wrapper-kindness" id="time_tracker_content">
			...
			<div class="wrapper-bank-r">
				<div class="bank-r">
					<div class="navi_right_top_box">
						<div class="navi_right_top_box1"><a onclick="ToggleContent('bank_withdraw');" href="javascript:void(0);">Buy Fuel</a></div>
					</div>
				</div>
		...
		<div class="wrapper-kindness" id="tutoring_content_ini">
			<div class="wrapper-kindness01">
				...
				<div class="tutering-content01">
					<h2 align="center" style='cursor:pointer; color:#FFF200;' onclick="ToggleContent('tutoring_start');">Launch Instant eTutoring</h2>
				</div>
			</div>
			<div class="wrapper-bank-r">
				<div class="bank-r">
				...
				<div class="bank-r">
					<div class="tuter6_main_top_bg">
						...
						<div class="hud_main_content">
							...
							<p align="center">To learn more about the Instant eTutoring service or<br/>
							to get started using it, please click 
							<span style='cursor:pointer; text-decoration:underline;' onclick="ToggleContent('tutoring_ini');">here</span>.</p>
							<br/>
							<br/>
							...
							<p align="center">To learn more about the Private eTutoring service please click 
							<span style='cursor:pointer; text-decoration:underline;' onclick="ToggleContent('tutoring_private');">here</span>.</p>
						</div>
					</div>
		...
		<div class="wrapper-kindness" id="generic_page_content" style="display:none;">
			<div class="wrapper-kindness01">
				<div id="generic_title" class="kindness-title"></div>
				<div id="generic_image" class="tutoring-image"></div>
				<div class="tutering-content01">
					Phasellus non eros sit amet ipsum suscipit facilisis. Aliquam eu eros ac lacus molestie porttitor quis ut 
					tortor. Nulla eleifend suscipit interdum. Cras nec velit ut neque placerat imperdiet at eget ligula. Aenean at 
					nulla augue. Nulla luctus ultrices adipiscing. Cum sociis natoque penatibus et magnis dis parturient montes, 
					nascetur ridiculus mus. Aliquam erat volutpat. Phasellus elementum volutpat dolor vitae semper. Sed accumsan 
					mollis lobortis. Etiam metus dui, consectetur non bibendum at, pharetra et velit. Duis mollis vehicula justo 
					nec condimentum. In luctus ornare commodo. 
				</div>
			</div>
			<div class="wrapper-bank-r">
				<div class="bank-r">
					<div class="tuter_main_top_bg">
						<div class="welcm_tutor_top_btn_arae">	
							<div class="welcm_tutor_top_btn">Welcome to <span id="generic_sub_title"></span></div>
						</div>
						<div class="welcm_tutor_top_txt">
							Nullam molestie vehicula malesuada. Cras ornare dui vitae mi iaculis tincidunt vehicula leo ornare. Sed 
							nisi justo, pharetra a semper. 
						</div>
					</div>
					<div class="tuter_main_bottom_bg" style="color:#54EC1A;">
						<div style="padding:15px 15px 0 15px">
							Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla fermentum viverra ligula vitae malesuada. Nam a 
							libero ac tellus vestibulum pulvinar et nec tortor. Sed et elit quam, nec viverra quam. In mattis, tellus nec 
							varius facilisis, enim leo adipiscing purus, et pellentesque ipsum urna sit amet mauris. Vivamus ultrices mi eu 
							turpis scelerisque pretium. Nulla ornare, lacus sit amet scelerisque pharetra, lacus risus dapibus nibh, sed 
							iaculis ligula sapien et massa. Quisque lacinia justo id leo condimentum sollicitudin. Quisque at urna sit amet 
							libero pharetra convallis. Proin ullamcorper, nibh ut pharetra pellentesque, neque lacus consequat lorem, vitae 
							gravida erat felis eget quam. Morbi porttitor turpis non diam dictum sagittis. Aliquam in massa tortor. Fusce nec 
							aliquet neque. Ut dignissim ultricies lorem, ullamcorper adipiscing lorem dictum sit amet.
						</div>
					</div>
				</div>
			</div>
			...
			<div class="wrapper-bank-r">
				<div class="bank-r">
					<div class="tuter_main_top_bg">
						...
						<div class="welcm_tutor_top_txt" style="color:#FFF200; font-size:0.9em; font-weight:bold;">
							Click here to visit the <u><a href="socialgo/redirect" target="_blank" style="color:#FFF200; font-size:0.9em; font-weight:bold;">Profile Page</a></u>.
						</div>
					</div>
				</div>
			</div>
		...
		<div class="wrapper-bank winXP" id="peace_content_about">
			<div class="wrapper-bank01">
				<div class="bank-title">Peace Building</div>
				...
				<div class="bank-content01" id="peace_about_text" style="margin-top:0px; width:287px; height:235px; overflow:auto;">
					...
					Peace Building is the overall purpose of the 1st Hope Corps, and your mission of hope is the key to building 
			...
			<div class="wrapper-bank-r">
				<div class="peace_content_box">
					<div class="welcm_tutor_top_btn" style="margin-left:5px;">How Peace Building works</div>
					<div class="hud_main_content winXP">
						<div id="peace_page_content_text" style="height:446px; overflow:auto;">
							...
							<p>The 1st Hope Corps - defines peace as "a state of mutual harmony between people; where virtues such as 
				...
				<div class="hud_peace_quick_links">
					...
					<div class="hud_peace_quick_links_right">
						<div id="quick_links_kindess_1" class="hud_peace_quick_links_right_links" style="width:90px;" onclick="ToggleContent('peace_kindness');">Kindness Program</div>
		...
		<div class="wrapper-bank" id="peace_content_kindness">
			<div class="wrapper-bank01">
				<div class="bank-title">Kindness Program</div>
				...
				<div class="bank-content01" id="peace_about_text" style="margin-top:0px; width:287px; height:235px; overflow:auto;">
					...
					<div style="color:#FFF200; width:270px; margin-top:35px;" align="center">
						<h2 style="cursor:pointer;" onclick="ToggleContent('peace_kindness_workz')">Kindness Workz</h2><br/>
						<h2 style="cursor:pointer;" onclick="ToggleContent('peace_kindness_act')">Act of Kindness</h2><br/>
						<h2 style="cursor:pointer;" onclick="ToggleContent('peace_kindness_reporter')">Kindness Reporter</h2>
					</div>
				</div>
			</div>
			<div class="wrapper-bank-r">
				<div class="peace_content_box">
					<div class="welcm_tutor_top_btn" style="margin-left:5px;">Welcome to Kindness Program</div>
					<div class="hud_main_content winXP">
				...
				<div class="hud_peace_quick_links">
					<div class="hud_peace_quick_links_left" style="width:75px;">Quick Links:</div>
					<div class="hud_peace_quick_links_right">
						<div id="quick_links_kindess_2" class="hud_peace_quick_links_right_links" style="width:90px; color:#FFF200;" onclick="ToggleContent('peace_kindness');">Kindness Program</div>
						<div class="hud_peace_quick_links_right_links" style="width:145px;" onclick="ToggleContent('peace_virtues');">Virtues and Values Program</div>
						<div class="hud_peace_quick_links_right_links" style="width:105px;" onclick="ToggleContent('peace_spirituality');">Spirituality Program</div>
		...
		<div class="wrapper-bank" id="peace_content_kindness_workz">
			...
			<div class="wrapper-bank-r">
				...
				<div class="hud_peace_quick_links">
					<div class="hud_peace_quick_links_left" style="width:75px;">Quick Links:</div>
					<div class="hud_peace_quick_links_right">
						<div id="quick_links_kindess_3" class="hud_peace_quick_links_right_links" style="width:90px; color:#FFF200;" onclick="ToggleContent('peace_kindness');">Kindness Program</div>
						<div class="hud_peace_quick_links_right_links" style="width:145px;" onclick="ToggleContent('peace_virtues');">Virtues and Values Program</div>
						<div class="hud_peace_quick_links_right_links" style="width:105px;" onclick="ToggleContent('peace_spirituality');">Spirituality Program</div>
						<div class="hud_peace_quick_links_right_links" style="width:40px;" onclick="ToggleContent('peace_about');">About</div>
					</div>
