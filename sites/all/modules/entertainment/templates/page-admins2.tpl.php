				<?php
					...
					foreach ($aTypes as $sType) {
						$aTypes[$sType]["cnt"] = _entertainment_editors_pending_items_title($sType,"admins",true);
												  ...
												  <td valign="top" align="center">
													<div style="width:690px;">
														<div class="<?php echo $aTypes["site"]["class"]; ?>" style="float:left;cursor">
															<div><p><?php echo $aTypes["site"]["cnt"]; ?></p><p class="lbl"><a href="<?php echo base_path(); ?>entertainment/getinvolved/admins/pending/sites">Websites</a></p></div>
														</div>
														<div class="<?php echo $aTypes["image"]["class"]; ?>" style="float:left;margin:0 70px 0 90px; text-align:center">
															<div><p><?php echo $aTypes["image"]["cnt"]; ?></p><p class="lbl"><a href="<?php echo base_path(); ?>entertainment/getinvolved/admins/pending/photos">Photos</a></p></div>
														</div>														
														<div class="<?php echo $aTypes["doc"]["class"]; ?>" style="float:left">
															<div><p><?php echo $aTypes["doc"]["cnt"]; ?></p><p class="lbl"><a href="<?php echo base_path(); ?>entertainment/getinvolved/admins/pending/books">Books</a></p></div>
														</div>
													</div>
												  </td>
											    </tr>
												  ...
												  <td valign="top" align="center">
													<div style="width:430px;">
														<div class="<?php echo $aTypes["video"]["class"]; ?>" style="float:left;">
															<div><p><?php echo $aTypes["video"]["cnt"]; ?></p><p class="lbl"><a href="<?php echo base_path(); ?>entertainment/getinvolved/admins/pending/videos">Videos</a></p></div>
														</div>
														<div class="<?php echo $aTypes["animation"]["class"]; ?>" style="float:left;margin-left:70px; text-align:center">
															<div><p><?php echo $aTypes["animation"]["cnt"]; ?></p><p class="lbl"><a href="<?php echo base_path(); ?>entertainment/getinvolved/admins/pending/animations">Animations</a></p></div>
														</div>														
													</div>
												  </td>
											    </tr>-->
