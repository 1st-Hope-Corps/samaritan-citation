										  ...
										  <tr>
											...
											<td style="padding-left:5px;">
												<div class="jboxh">
													...
													<div class="jboxbody">
														<div class="jboxcontent">
                                                            <form id="entertainment_file_add" method="post" action="<?php echo base_path(); ?>mystudies/file/edit/add/response" enctype="multipart/form-data" onsubmit="return ValidateUpload();">
																<input type="hidden" id="iUserId" name="iUserId" value="<?php echo _tplvar('iUserId'); ?>" />
