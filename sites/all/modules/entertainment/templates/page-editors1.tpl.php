													...
													<tr>
														<td width="370" align="left">
															<table style="margin:0 0 13px;">
																<tr>
																	...
																	<td style="padding:0;">
																		...
																		<input type="hidden" id="entertainment_sVolunteerType" name="entertainment_sVolunteerType" value="editor" />
															...
															<div class="jbox">
																...
																<div class="jboxbody">
																	<div class="jboxcontent" style="text-align:center">
																		...
																		<table cellpadding="0" cellspacing="0" border="0">
																			...
																			<tr><td><input type="image" id="entertainment_editor_pending_items" onclick="Volunteer_CheckIfToFollowlink('<?php echo _tplvar('bCanDoSomething') ?>', '<?php echo base_path(); ?>entertainment/getinvolved/editors/pending');" <?php //echo _tplvar('sDisabled'); ?> src="<?php echo THEME_IMGPATH; ?>btn_blue_editpendingitems.gif" border="0" /></td></tr>
																			<tr><td><input type="image" id="entertainment_editor_existing_items" onclick="Volunteer_CheckIfToFollowlink('<?php echo _tplvar('bCanDoSomething') ?>', '<?php echo base_path(); ?>entertainment/getinvolved/editors/existing/items');" <?php //echo _tplvar('sDisabled'); ?> src="<?php echo THEME_IMGPATH; ?>btn_blue_editexistingitems.gif" border="0" /></td></tr>
																			<tr><td><input type="image" id="entertainment_editor_existing_cats" onclick="Volunteer_CheckIfToFollowlink('<?php echo _tplvar('bCanDoSomething') ?>', '<?php echo base_path(); ?>entertainment/getinvolved/editors/existing/cats');" <?php //echo _tplvar('sDisabled'); ?> src="<?php echo THEME_IMGPATH; ?>btn_blue_editexistingcategories.gif" border="0" /></td></tr>
																		</table>
																		
																		<div id="entertainment_NoFeatureDialog" title="Editor Notice">
																...
																<?php
																$iFreeGuideCount = _entertainment_volunteer_available();
																	...
																	<div class="jboxcontent">
																		<table width="100%" cellpadding="0" cellspacing="0" border="0" id="gi_editor_stats">
																						...
																						<div class="jboxbody">
																							<div class="jboxcontent">
																								<div style="float:left; margin-right:10px;">
																									<form method="post" action="<?php echo base_path(); ?>entertainment/getinvolved/editors/assign/guides">
																										<select id="entertainment_editor_guides_count" name="entertainment_editor_guides_count">
																										...
																										<input type="image" align="absmiddle" id="entertainment_editor_guides_count_post" <?php echo ((_entertainment_volunteer_available() == 0) ? 'disabled="disabled"':''); ?> name="entertainment_editor_guides_count_post" src="<?php echo THEME_IMGPATH; ?>btn_blue_set.png" border="0" /></a>
																									</form>
																								</div>
																			...
																			<tr>
																				<td colspan="2">
																					<div class="gi_green" align="center" style="float:left">
																						<div><p><?php echo _entertainment_volunteer_rec_count(_tplvar('iUserId'), "editor"); ?></p>Items you have edited</div>
																					</div>
																			...
																			<tr>
																				<td colspan="2">
																					<div class="gi_pink" align="center">
																						<div><p><?php echo _entertainment_editors_pending_count(); ?></p>Items waiting for you to edit</div>
																					</div>
																				</td>
																			</tr>
																			<tr>
																				<td colspan="2">
																					<div class="gi_pink" align="center">
																						<div><p><?php echo _entertainment_editors_pending_count("guides"); ?></p>Guides waiting for you</div>
																					</div>
																				</td>
																			</tr>
																			<tr>
																				...
																				<td valign="top">
																					...
																					<div class="jbox">
																						...
																						<div class="jboxbody">
																							<div class="jboxcontent">
																								Click <a href="javascript:void(0);" id="entertainment_guides_block_show">here</a> to see your assigned Guides and Administrator<br />
