												...
												<div class="jbox">
													...
													<div class="jboxbody">
														<div class="jboxcontent" style="height:350px;">
															<div style="height:310px;padding:0px 20px 10px 0px;overflow:auto;margin-bottom:0px;">
																<ul id="entertainment_VolunteerCatList"></ul>
															</div>
														
															<div style="text-align:right;margin:10px 0 0 0;">
																Enter Url or Embed Code:
																<input type="text" id="searchtxt" name="searchtxt" />
																<input type="button" id="searchsubmit" name="searchsubmit" value=" Search " />
															</div>
														</div>
													</div>
														...
														<div class="jboxcontent" style="height:350px">
															<div style="width:90%">
																...
																<div class="gi_white" align="center">
																	<p>
																		<input type="hidden" id="guides_sContentType" name="guides_sContentType" value="content" />
																		<!--<select id="guides_sContentType" >
																...
																<br />
																<input type="image" id="guides_btnGo" style="margin-right:50px;" src="<?php echo THEME_IMGPATH; ?>btn_blue_go.gif" border="0" />
																<input type="image" id="guides_btnCancel" src="<?php echo THEME_IMGPATH; ?>btn_blue_cancel.gif" border="0" />
				...
				<div id="search_results" style="display:none">
					...
					<div id="cbtop">
						<div class="cbb">
							<div class="left-border">
								<div class="right-border">
									<h4>Search Results <span class="search_close">[Close]</h4>
									<div id="search_contents">
                                        <ul class="search">
                                            <li><a href="#">Search Result1</a> - Lorem ipsum dolor sit amet sfadafff dkdisdc asddio dff dfi asdfasd idi di adlfad</li>
                                            <li><a href="#">Search Result1</a> - Lorem ipsum dolor sit amet sfadafff dkdisdc asddio dff dfi asdfasd idi di adlfad</li>
                                            <li><a href="#">Search Result1</a> - Lorem ipsum dolor sit amet sfadafff dkdisdc asddio dff dfi asdfasd idi di adlfad</li>
                                            <li><a href="#">Search Result1</a> - Lorem ipsum dolor sit amet sfadafff dkdisdc asddio dff dfi asdfasd idi di adlfad</li>
                                        </ul>
										<div class="pager">1 2 3 4 5</div>
                                    </div>
								</div>
							</div>					
						</div>
