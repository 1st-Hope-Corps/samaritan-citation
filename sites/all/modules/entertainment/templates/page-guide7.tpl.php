												...
												<div class="jboxh" align="center">
													...
													<div class="jboxbody">
														<div class="jboxcontent">
															<form id="entertainment_file_add_embed" method="post" action="<?php echo base_path(); ?>entertainment/file/edit/add" enctype="multipart/form-data" onsubmit="return ValidateEmbed();">
																...
																<input type="hidden" name="sRedirectTo" value="<?php echo base_path(); ?>entertainment/getinvolved/guides?b=1" />
																<input type="hidden" id="rating_iRatingId" name="rating_iRatingId" value="0" />
																<input type="hidden" id="content_type" name="contenttype" value="games" />
																...
																<table>
																	...
																	<tr>
																		<td style="padding-top:5px;">Thumbnail URL:</td>
																		<td style="padding-top:5px;"><input type="text" id="sFileEmbedThumbURL" name="sFileEmbedURL" style="width:300px;" /></td>
																	</tr>
																	<tr>
