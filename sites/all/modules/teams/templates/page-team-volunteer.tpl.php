...
<head>
<link class="ka_style" rel="stylesheet" type="text/css" href="<?php echo base_path(); ?>sites/all/modules/mystudies/jquery.tooltip.css" />
<link class="ka_style" rel="stylesheet" type="text/css" href="<?php echo base_path(); ?>sites/all/modules/mystudies/redmond/jquery-ui-custom.css" />
<script type="text/javascript" src="<?php echo base_path(); ?>sites/all/modules/kickapps/kickapps.js"></script>
<script type="text/javascript" src="<?php echo base_path(); ?>sites/all/modules/mystudies/jquery.tooltip.js"></script>
<script type="text/javascript" src="<?php echo base_path(); ?>sites/all/modules/mystudies/jquery-ui.js"></script>
...
<link class="ka_style" rel="stylesheet" id="LE_setCSS" type="text/css" href="<?php echo base_path(); ?>themes/theme2010/getKickplacecss.members.css" />
<link type="text/css" rel="stylesheet" media="all" href="<?php echo base_path(); ?>themes/theme2010/kickapps_members.css" />
	...
	<div id="ka_header" class="clearfix">
		<div id="ka_headerTopNav" style="display:block;">
			...
			<ul id="ka_headerTopNav_ul">
				<li id="ka_homeTab">
						<a id="ka_myhomeTab_nav" href="<?php echo base_path(); ?>community?css=kickapps_theme2010"><span>dashboard</span></a>
					</li>
				<li id="ka_videoTab" >
						<a id="ka_videoTab_nav" href="<?php echo base_path(); ?>community?m=v&css=kickapps_theme2010"><span>videos</span></a>
					</li>
				<li id="ka_audioTab" >
						<a id="ka_audioTab_nav" href="<?php echo base_path(); ?>community?m=a&css=kickapps_theme2010"><span>audio</span></a>
					</li>
				<li id="ka_photoTab" >
						<a id="ka_photoTab_nav" href="<?php echo base_path(); ?>community?m=p&css=kickapps_theme2010"><span>photos</span></a>
					</li>
				<li id="ka_blogTab" >
						<a id="ka_blogTab_nav" href="<?php echo base_path(); ?>community?m=b&css=kickapps_theme2010"><span>blogs</span></a>
					</li>
				<li id="ka_memberTab">

						<a id="ka_memberTab_nav" href="<?php echo base_path(); ?>community/members?css=kickapps_theme2010"><span>members</span></a>
					</li>
				<li id="ka_groupsTab" class="current">
						<a id="ka_groupsTab_nav" href="<?php echo base_path(); ?>community/teams"><span>teams</span></a>
					</li>
				<li id="ka_messageBoardsTab" >
					<a id="ka_messageBoardsTab_nav" href="<?php echo base_path(); ?>community?m=mb&css=kickapps_theme2010"><span>message board</span></a>
				</li>
				</ul>
...
<div id="ka_headerBtmNav" class="clearfix">
		   ...
		   <form name="ka_search" method="get" action="<?php echo base_path(); ?>community" enctype="application/x-www-form-urlencoded" accept-charset="UTF-8" >
