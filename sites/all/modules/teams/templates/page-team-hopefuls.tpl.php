...
<script type="text/javascript" src="<?php echo base_path(); ?>misc/drupal.js"></script>
...
<link class="ka_style" rel="stylesheet" id="LE_setCSS" type="text/css" href="<?php echo base_path(); ?>themes/theme2010/getKickplacecsshopeful.members.css" />
...
body {
    ...
    background-image: url("<?php echo base_path(); ?>hud_files/images/bg.jpg") !important;
		...
		<div id="ka_headerTopNav" style="display:block;">
			...
			<ul id="ka_headerTopNav_ul">
				...
				<li id="ka_memberTab">
						...
						<a id="ka_memberTab_nav" href="<?php echo base_path(); ?>community/members"><span>members</span></a>
					</li>
				...
				<div id="ka_headerLoginAuth">
					<ul id="ka_login_area">
						<li class="ka_username_welcome">
							<a id="MyProfileMember" href=""><span style="color:#b8b800;text-decoration:underline;font-size:11px;">My Profile</span></a></span>&nbsp;&nbsp;&nbsp;<a id="MyProfileMember" href="<?php echo base_path(); ?>user/ext/account/hud"><span style="color:#b8b800;text-decoration:underline;font-size:11px;">My Account</span></a></span>
							<?php
							global $user;
							?>
