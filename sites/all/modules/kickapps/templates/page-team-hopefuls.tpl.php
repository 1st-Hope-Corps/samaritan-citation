...
<link rel="stylesheet" type="text/css" href="http://www.firsthopecorps.org/<?php print base_path().path_to_theme() ?>/sf/superfish.css" />
<link rel="stylesheet" type="text/css" href="http://www.firsthopecorps.org/<?php print base_path().path_to_theme() ?>/sf/superfish-navbar.css" />  
<script type="text/javascript" src="http://www.firsthopecorps.org/<?php print base_path().path_to_theme() ?>/cb.js"></script>
<script type="text/javascript" src="http://www.firsthopecorps.org/<?php print base_path().path_to_theme() ?>/sf/hoverIntent.js"></script>
<script type="text/javascript" src="http://www.firsthopecorps.org/<?php print base_path().path_to_theme() ?>/sf/superfish.js"></script>
									...
									$("#teams_InviteDialog").dialog(
										{
											...
											buttons: {
												"I have selected this team": function(){
													location = "http://www.firsthopecorps.org/community?m=gr&css=kickapps_theme2010";
												},
...
<div id="ka_manageContent" class="clearfix" style="background-color:#386631;border: 2px solid #e5f031;">
