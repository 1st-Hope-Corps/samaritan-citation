													...
													<div class="jboxbody">
														<div class="jboxcontent" style="height:350px;">
															<div style="height:320px;padding:0px 20px 10px 0px;overflow:auto;">
																<ul id="mystudies_VolunteerCatList"><li id="0"><span id="0" style="background-color:#FFFFCC; padding:3px;">Main Level</span></li></ul>
															</div>
														</div>
													</div>
												...
												<div class="jbox">
													...
													<div class="jboxbody">
														<div class="jboxcontent" style="height:350px;color:#000">
															<form id="editors_query_form" name="editors_query_form" method="post" action="<?php echo base_path(); ?>mystudies/getinvolved/<?php echo _tplvar('sLoggedType'); ?>/existing/cats">
				                                            	<input type="hidden" id="volunteer_iGroupId" name="iGroupId" value="0" />
                                                                ...
                                                                <div style="width:90%">
																	...
																	<table>
                                                                        <tr>
                                                                            <td style="padding:10px 10px 10px 0px;"><input type="radio" id="mystudies_editors_cat_add" name="editors_cat_option" value="add" '.((isset($_REQUEST["iGroupId"])) ? '':'checked="checked"').' /></td>
                                                                            <td style="padding:10px 0px 10px 0px;"><label for="mystudies_editors_cat_add">Add a new subject/category</label></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="padding:0px 10px 20px 0px;"><input type="radio" id="mystudies_editors_cat_edit" name="editors_cat_option" value="edit" '.((isset($_REQUEST["iGroupId"])) ? 'checked="checked"':'').' /></td>
                                                                            <td  style="padding:0px 0px 20px 0px;"><label for="mystudies_editors_cat_edit">Edit an existing subject/category</label></td>
                                                                        </tr>
                                                                    </table>
																	<br /><br /><br /><br />
																	<button type="button" id="editors_btnGo" class="btn_blue_go" style="width:150px;"></button>
																	<button type="button" id="editors_btnCancel" class="btn_blue_cancel" onclick="location='<?php echo base_path(); ?>mystudies/getinvolved/<?php echo _tplvar('sLoggedType'); ?>'"></button>
                    				...
                    				<div class="jboxh" style="width:980px">
                                        ...
                                        <div class="jboxbody">
                                            <div class="jboxcontent">
                                                <form id="mystudies_add" method="post" action="<?php echo base_path(); ?>mystudies/getinvolved/<?php echo _tplvar('sLoggedType'); ?>/existing/cats/add/process" enctype="multipart/form-data" onsubmit="return ValidateForm();" style="margin:20px 0px 0px 70px;">
                                                    <input type="hidden" id="volunteer_iGroupId" name="iGroupLevel" value="0" />
                                                    <input type="hidden" name="sRedirectTo" value="<?php echo base_path(); ?>mystudies/getinvolved/<?php echo _tplvar('sLoggedType'); ?>/existing/cats" />
