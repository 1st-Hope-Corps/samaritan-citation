							...
							<div class="right-border">
								<table width="980" border="0" cellpadding="0" cellspacing="0">
									<tr>
								      ...
								      <td valign="top" align="left" class="gi_title">Please add below the Title, Tags, Description and the Rating of the <span id="linkTitle"></span></td>
								    </tr>
									<tr>
									  <td>&nbsp;</td>	
									  <td>
									  	...
									  	<div class="jbox">
											...
											<div class="jboxbody">
												<div class="jboxcontent">
													<form action="<?php echo base_path(); ?>mystudies/url/edit/add" method="post" onsubmit="return ValidateSiteForm();">
														...
														<table>
															<tr>
																<td style="width:150px; padding-bottom:10px;">URL:</td>
															...
															<tr>
																<td style=" padding-bottom:10px;">Grade:</td>
															...
															<tr>
																<td style=" padding-bottom:10px;padding-top:10px; ">Difficulty:</td>
															...
															<tr>
																<td style=" padding-bottom:10px;">Tags:<br /><small>Primary Learning Objective</small></td>
																<td style="padding-bottom:10px;">
																	<input type="text" id="pTags" name="pTags" value="" style="width:400px;" /><br/>
																	<small>Separate tags with a comma (eg. space,shuttle,service).</small>
																</td>
															</tr>
															<tr>
																<td style=" padding-bottom:10px;">Tags:<br /><small>Secondary Learning Objective</small></td>
																<td style="padding-bottom:10px;">
