										  ...
										  <tr>
											...
											<td valign="top" style="padding-left:5px;" align="center">
												<div class="jbox">
													...
													<div class="jboxbody">
														<div class="jboxcontent" style="height:350px">
															<form name="edit_existing_items" method="post" action="<?php echo base_path(); ?>mystudies/getinvolved/<?php echo _tplvar('sLoggedType'); ?>/existing/items">
																...
																<div style="width:90%">
																	...
																	<img style="cursor:pointer;" id="editors_btnCancel" onclick="location='<?php echo base_path(); ?>mystudies/getinvolved/<?php echo _tplvar('sLoggedType'); ?>'" src="<?php echo THEME_IMGPATH; ?>btn_blue_cancel.png" border="0" />
