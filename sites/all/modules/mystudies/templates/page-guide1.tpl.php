													...
													<tr>
															...
															<div class="jbox">
																<table style="margin:0 0 13px;">
																	<tr>
																		...
																		<td>&nbsp;</td>
																		<td style="padding:0;">
																			<div id="mystudies_btnVolunteerDeactivate" class="jbox" style="width:277px; height:60px;">
																				<div class="jboxhead"><h2></h2></div>
																				<div class="jboxbody">
																					<div class="jboxcontent" style="text-align:center;">
																			...
																			<input type="hidden" id="mystudies_sVolunteerType" name="mystudies_sVolunteerType" value="guide" />
																...
																<div class="jboxbody">
																	<div class="jboxcontent" style="text-align:center">
																		<img id="MyStudiesGuides" src="<?php echo THEME_IMGPATH; ?>gi_guide_clicktorecommend.jpg" border="0" />
																		<div id="mystudies_NoFeatureDialog" title="Guide Notice">
														...
														<td align="right">
															<div class="jbox">
																...
																<div class="jboxbody">
																	<div class="jboxcontent" style="text-align:center">
																		<div id="seeRecommend_dialog" title="Coming soon" style="display:none;">
																		Coming soon!
																		</div>
																		...
																		<!--<div class="gi_green" align="center">
																			<div><p><?php //echo _mystudies_volunteer_rec_count(_tplvar('iUserId')); ?></p>Items you have recommended</div>
																		</div>-->
																		...
																		<p class="gi_comment">Click <a href="javascript:void(0);" id="seeRecommend">here</a> to see all of your recommended items</p>
