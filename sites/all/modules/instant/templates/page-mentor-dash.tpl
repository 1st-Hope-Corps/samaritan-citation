																...
																<div class="jboxbody">
																	<div class="jboxcontent" style="text-align:center">
																		<div class="jbox">
																			...
																			<div class="jboxbody">
																				<div class="jboxcontent" style="text-align:center">
																					Choose the Kindness Workz that you wish to review and then click one of the following buttons below:
																				</div>
																			</div>
																			<div class="jboxfoot"><p></p></div>
																		</div>
																		...
																		<table cellpadding="0" cellspacing="0" border="0">
																			...
																			<tr><td><input type="image" id="kindness_mentor_pending" onclick="location='/kindness/mentor/pending'" src="<?php echo THEME_IMGPATH; ?>btn_blue_pendingkindness.gif" border="0" /></td></tr>
																			<tr><td><input type="image" id="kindness_mentor_approve" onclick="location='/kindness/mentor/approve'" src="<?php echo THEME_IMGPATH; ?>btn_blue_approvekindness.gif" border="0" /></td></tr>
																			<tr><td><input type="image" id="kindness_mentor_disapprove" onclick="location='/kindness/mentor/disapprove'" src="<?php echo THEME_IMGPATH; ?>btn_blue_disapprovekindness.gif" border="0" /></td></tr>
																		</table>
																	...
																	<div class="jboxcontent">
																		<table width="100%" cellpadding="0" cellspacing="0" border="0" id="gi_editor_stats">
																			<tr>
																				<td colspan="2">
																					<div class="gi_pink" align="center">
																						<div><p><?php echo _tplvar('iAvailableHopefuls') ?></p>Hopefuls not assigned a Mentor</div>
																					</div>
																				</td>
																			</tr>
																			<tr>
																					...
																					<div class="jbox">
																						...
																						<div class="jboxbody">
																							<div class="jboxcontent">
																								...
																								Select from the Drop-Down Box the number of Benefactor that you wish to review.
																							</div>
																						</div>
																						<div class="jboxfoot"><p></p></div>
																					</div>
																			...
																			<tr>
																				<td colspan="2" valign="middle">
																					<div class="gi_green" align="center" style="float:left">
																						<div><p><?php echo _tplvar('iRequest') ?></p>Hopefuls you have requested</div>
																					</div>
																				</td>
																			</tr>
																			<tr>
																				<td colspan="2" valign="middle">
																					<div class="gi_green" align="center" style="float:left">
																						<div><p><?php echo _tplvar('iAssignedHopeful') ?></p>Hopefuls assigned to you</div>
																					</div>
																			...
																			<tr>
																				<td colspan="2">
																					<div class="gi_green" align="center" style="float:left">
																						<div><p><?php echo _tplvar('iApprovedWorkz') ?></p>Kindness Workz you've mentored</div>
																					</div>
																				</td>
																			</tr>
																			<tr>
																			...
																			<tr>
																				<td colspan="2">
																					<div class="gi_pink" align="center">
																						<div><p><?php echo _tplvar('iWaitingHopefuls') ?></p>Hopefuls waiting for you</div>
																					</div>
																				</td>
																			</tr>
																			<tr>
																					...
																					<div class="jbox">
																						...
																						<div class="jboxbody">
																							<div class="jboxcontent">
																								...
																								Click <a href="#">here</a> to see the Community of all Mentor Volunteers.
 																							</div>
																						</div>
																						<div class="jboxfoot"><p></p></div>
																					</div>
