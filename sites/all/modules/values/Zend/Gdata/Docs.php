...
class Zend_Gdata_Docs extends Zend_Gdata
{
                               ...
                               $uri=null,$extraHeaders=array())
    {
        ...
        return $this->insertDocument($fs, $uri, 'Zend_Gdata_Docs_DocumentListEntry', $extraHeaders);
    }
    ...
    public function insertDocument($data, $uri,
        $className='Zend_Gdata_Docs_DocumentListEntry', $extraHeaders = array())
    {
        return $this->insertEntry($data, $uri, $className, $extraHeaders);
    }
