															...
															<div class="jbox">
																<table style="margin:0 0 13px;">
																	<tr>
																		...
																		<td>&nbsp;</td>
																		<td style="padding:0;">
																			<div id="values_btnVolunteerDeactivate" class="jbox" style="width:277px; height:60px;">
																				<div class="jboxhead"><h2></h2></div>
																				<div class="jboxbody">
																					<div class="jboxcontent" style="text-align:center;">
																			...
																			<input type="hidden" id="values_sVolunteerType" name="values_sVolunteerType" value="guide" />
																...
																<div class="jboxbody">
																	<div class="jboxcontent" style="text-align:center">
																		<img id="valuesGuides" src="<?php echo THEME_IMGPATH; ?>gi_guide_clicktorecommend.jpg" border="0" />
																		<div id="values_NoFeatureDialog" title="Guide Notice">
																...
																<div class="jboxbody">
																	<div class="jboxcontent" style="text-align:center">
																		...
																		<!--<div class="gi_green" align="center">
																			<div><p><?php //echo _values_volunteer_rec_count(_tplvar('iUserId')); ?></p>Items you have recommended</div>
																		</div>-->
