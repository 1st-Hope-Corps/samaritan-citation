								...
								<table width="970" border="0" cellspacing="0" cellpadding="2">
								  <tr>
									...
									<td valign="top">
										...
										Volunteer - Editors are crucial to the success of the HopeGames - Entertainment Portal program. Our
										HopeGames Editors helps us ensure that the Entertainment Portal is a high quality and safe experience for the
										...
										HopeGames uses Guides to recommend contents for the Entertainment Portal and each of these
										...
										If all is well, then the Editor will approve the item of content and then submits it to the HopeGames
										Administrator to be uploaded to the Entertainment Portal. However, if the item is disapproved, he will
										...
										items of content each week to HopeGames for editing. Which would amount to 20 - 30 items of content to
