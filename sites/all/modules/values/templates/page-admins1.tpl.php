													...
													<tr>
														<td width="370" align="left">
															<table style="margin:0 0 13px;">
																<tr>
																	...
																	<td style="padding:0;">
																		...
																		<input type="hidden" id="values_sVolunteerType" name="values_sVolunteerType" value="admin" />
															...
															<div class="jbox">
																		...
																		<table cellpadding="0" cellspacing="0" border="0">
																			<tr>
																				<td valign="top">
                                                                                	...
                                                                                	<div style="height:60px;"><input type="image" id="values_admin_pending_items" onclick="Volunteer_CheckIfToFollowlink('<?php echo _tplvar('bCanDoSomething') ?>', '<?php echo base_path(); ?>values/getinvolved/admins/pending/items');" src="<?php echo THEME_IMGPATH; ?>btn_blue_administerpendingcontent.png" border="0" /></div>
                                                                                	<div style="height:70px;"><input type="image" id="values_admin_existing_items" onclick="Volunteer_CheckIfToFollowlink('<?php echo _tplvar('bCanDoSomething') ?>', '<?php echo base_path(); ?>values/getinvolved/admins/existing/items');" src="<?php echo THEME_IMGPATH; ?>btn_blue_administerexistingcontent.png" border="0" /></div>
																					<div style="height:70px;"><input type="image" id="values_admin_pending_cats" onclick="Volunteer_CheckIfToFollowlink('<?php echo _tplvar('bCanDoSomething') ?>', '<?php echo base_path(); ?>values/getinvolved/admin/pending/subjects');" src="<?php echo THEME_IMGPATH; ?>btn_blue_administerpendingcategories.png" border="0" /></div>
																					<div><input type="image" id="values_admin_existing_cats" onclick="Volunteer_CheckIfToFollowlink('<?php echo _tplvar('bCanDoSomething') ?>', '<?php echo base_path(); ?>values/getinvolved/admins/existing/cats');" src="<?php echo THEME_IMGPATH; ?>btn_blue_administerexistingcategories.png" border="0" /></div>
                                                                                </td>
																				<td valign="top" rowspan="5" valign="top"><img src="<?php echo THEME_IMGPATH; ?>gi_admin_line.gif" border="0" /></td>
																			</tr>
																		</table>
																		
																		<div id="values_NoFeatureDialog" title="Administrator Notice">
																...
																<?php
																$iFreeEditorCount = _values_volunteer_available("editor");
																	...
																	<div class="jboxcontent">
																		<table width="100%" cellpadding="0" cellspacing="0" border="0" id="gi_editor_stats">
																			<tr>
																				<td colspan="2">
																					<div class="gi_pink" align="center">
																						<div><p><?php echo _values_volunteer_available("editor"); ?></p>Editors not assigned an Admin</div>
																					</div>
																				</td>
																			</tr>
																			<tr>
																						...
																						<div class="jboxbody">
																							<div class="jboxcontent">
																								<div style="float:left; margin-right:10px;">
																									<form method="post" action="<?php echo base_path(); ?>values/getinvolved/admin/assign/editors">
																										<select id="values_admin_editors_count" name="values_admin_editors_count" style="font-size:1.2em; font-weight:bold; vertical-align:bottom;">
																										...
																										<input type="image" id="values_editor_guides_count_post" name="values_editor_guides_count_post" align="absmiddle" <?php echo ((_values_volunteer_available("editor") == 0) ? 'disabled="disabled"':''); ?> src="<?php echo THEME_IMGPATH; ?>btn_blue_set.png" border="0" /></a>
																									</form>
																								</div>
																			...
																			<tr>
																				<td colspan="2" valign="middle">
																					<div class="gi_green" align="center" style="float:left">
																						<div><p><?php echo _values_volunteer_assigned_count("admin"); ?></p>Editors assigned to you</div>
																					</div>
																			...
																			<tr>
																				<td colspan="2">
																					<div class="gi_green" align="center" style="float:left">
																						<div><p><?php echo _values_volunteer_rec_count(_tplvar('iUserId'), "admin"); ?></p>Items you have Administered</div>
																					</div>
																			...
																			<tr>
																				<td colspan="2">
																					<div class="gi_pink" align="center">
																						<div><p><?php echo _values_admins_pending_count(); ?></p>Items waiting to be Administered</div>
																					</div>
																				</td>
																			</tr>
																			<tr>
																				<td colspan="2">
																					<div class="gi_pink" align="center">
																						<div><p><?php echo _values_admins_pending_count("editor"); ?></p>Editors waiting for you</div>
																					</div>
																				</td>
																			</tr>
																			<tr>
																				...
																				<td valign="top">
																					...
																					<div class="jbox">
																						...
																						<div class="jboxbody">
																							<div class="jboxcontent">
																								Click <a href="javascript:void(0);" id="values_guides_block_show">here</a> to see your assigned Editors<br />
