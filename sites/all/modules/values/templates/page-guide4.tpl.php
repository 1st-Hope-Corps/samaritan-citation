										  ...
										  <tr>
											...
											<td style="padding-left:5px;">
												<div class="jboxh">
													...
													<div class="jboxbody">
														<div class="jboxcontent">
															<form id="values_file_add" method="post" action="<?php echo base_path(); ?>values/file/edit/add/response" enctype="multipart/form-data" onsubmit="return ValidateUpload();">
																<input type="hidden" id="iUserId" name="iUserId" value="<?php echo _tplvar('iUserId'); ?>" />
																...
																<input type="hidden" id="response_url" name="response_url" value="<?php echo base_path(); ?>values/file/edit/add/response" />
																<input type="hidden" name="sRedirectTo" value="<?php echo base_path(); ?>values/getinvolved/guides?b=1" />
																<input type="hidden" id="rating_iRatingId" name="rating_iRatingId" value="0" />
